...
public class CommentFragment extends Fragment
{
    ...
    {
        final LinkedList<Comment> listCmt = new LinkedList<>();
        LinkedList<Movie> listMovie = null;
        listCmt.add(new Comment("Nguoi dung 1", "Phim hay lam do"));
        listCmt.add(new Comment("Nguoi dung 2", "Phim khong te"));
        listCmt.add(new Comment("Nguoi dung 3", "Phim chan lam"));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Comment binhLuan = new Comment("Nguoi dung 4", cmt);
                listCmt.addLast(binhLuan);
                RecyclerAdapter reAdapter = new RecyclerAdapter(listMovie, getContext(), listCmt);
        ...
        RecyclerAdapter reAdapter = new RecyclerAdapter(listMovie, this.getContext(),  listCmt);
        recyclerView.setAdapter(reAdapter);
